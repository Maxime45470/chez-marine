...
class CategoriesController extends AbstractController
{
    ...
    public function index(PhotoGroupeRepository $photoGroupeRepository,CategoriesRepository $categoriesRepository): Response
    {
        return $this->render('categories/index.html.twig', [
            'categories' => $categoriesRepository->findAll(),
            'photoGroupe' => $photoGroupeRepository->findBy(['categories' => ('id')]),
    ...
    public function new(Request $request, CategoriesRepository $categoriesRepository): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $image->move(
                $this->getParameter('image_directory_categories'),
                $fichier
            );
